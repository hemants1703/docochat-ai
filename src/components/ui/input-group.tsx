...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-center rounded-2xl border border-border/40 bg-background/50 backdrop-blur-xl shadow-sm transition-all outline-none dark:bg-muted/20",
        ...
        // Focus state.
        "has-[[data-slot=input-group-control]:focus-visible]:border-ring/50 has-[[data-slot=input-group-control]:focus-visible]:ring-[3px] has-[[data-slot=input-group-control]:focus-visible]:ring-ring/20 has-[[data-slot=input-group-control]:focus-visible]:bg-background/80",
...
function InputGroupTextarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <Textarea
      ...
      className={cn("flex-1 resize-none rounded-none border-0 bg-transparent py-3 shadow-none focus-visible:ring-0 placeholder:text-muted-foreground/60 transition-colors dark:bg-transparent", className)}
      {...props}
    />
  );
}
