...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      "is-user:dark flex w-fit min-w-0 max-w-[90%] flex-col gap-2 overflow-hidden text-[15px] leading-relaxed",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-2xl group-[.is-user]:rounded-br-sm group-[.is-user]:bg-primary group-[.is-user]:px-4 group-[.is-user]:py-2.5 group-[.is-user]:text-primary-foreground group-[.is-user]:shadow-sm",
      "group-[.is-assistant]:text-foreground group-[.is-assistant]:px-2",
      className,
    )}
    {...props}>
    {children}
